...
<a href="https://anubhavchakrabortynits.github.io/inotes/#/login"  rel='noreferrer' className="projects list-group-item list-group-item-action " target="_blank" >iNoteBook</a>
</div>
<div className="col-lg-4 col-md-6">
<a href="https://imggallery1.herokuapp.com/login/"  rel='noreferrer' className="projects list-group-item list-group-item-action " target="_blank" >Image gallery</a>
</div>
<div className="col-lg-4 col-md-6">
<a href="https://anubhavchakrabortynits.github.io/myweatherapp/"  rel='noreferrer' className="projects list-group-item list-group-item-action " target="_blank" >Weatherapp</a>
</div>
<div className="col-lg-4 col-md-6">
<a href="https://anubhavchakrabortynits.github.io/newrecipe/"  rel='noreferrer' className="projects list-group-item list-group-item-action " target="_blank" >Recipe Search app</a>
</div>
<div className="col-lg-4 col-md-6">
...
<div className="col-lg-4 col-md-6">
  ...
  <a href="https://anubhavchakrabortynits.github.io/textutils/" rel="noreferrer" className='projects list-group-item list-group-item-action' target="_blank">Text Analyser</a>
</div>
...
<div className="col-lg-4 col-md-6">
<a href="https://anubhavchakrabortynits.github.io/dashboardamazon/"  rel='noreferrer' className="projects list-group-item list-group-item-action " target="_blank" >Amazon US dashboard static clone</a>
</div>
